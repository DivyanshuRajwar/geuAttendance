...
function Attendance() {
    ...
    const handleGenerate =  async(event) => {
        ...
        if(!classId && (!course || !semester || ! section)){
          alert("Please fill out either the custom class ID or all course details.");
          return;
        }
        if(!subject){
                    ...
                    <form onSubmit={handleGenerate} className="flex flex-col space-y-6">
                        ...
                        <div className="flex justify-between">
                            <div className="w-1/2 pr-2">
                                <label className="block mb-1 font-semibold text-gray-700 text-xl">Course</label>
                                <input
                                    type="text"
                            ...
                            <div className="w-1/2 pl-2">
                                <label className="block mb-1 font-semibold text-gray-700 text-xl">Semester</label>
                                <input
                                    type="number"
                                    placeholder="1, 2, 3"
                                    value={semester}
                        ...
                        <div className="flex justify-between">
                            <div className="w-1/2 pr-2">
                                <label className="block mb-1 font-semibold text-gray-700 text-xl">Section</label>
                                <input
                                    type="text"
                                    placeholder="A, B, C"
                                    value={section}
                            ...
                            <div className="w-1/2 pl-2">
                                <label className="block mb-1 font-semibold text-gray-700 text-xl">Subject Code</label>
                                <input
                                    type="text"
                        ...
                        <div className="flex justify-between">
                            <div className="w-1/2 pr-2">
                                <label className="block mb-1 font-semibold text-gray-700 text-xl">Class ID</label>
                                <input
                                    type="text"
                            ...
                            <div className="w-1/2 pl-2">
                                <label className="block mb-1 font-semibold text-gray-700 text-xl">Date</label>
                                <input
                                    type="text"
                                    value={today}
                                    readOnly
